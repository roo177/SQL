-- View: public.q_cb_mod_profit_usd

-- DROP VIEW public.q_cb_mod_profit_usd;

CREATE OR REPLACE VIEW public.q_cb_mod_profit_usd
 AS
...
ALTER TABLE public.q_cb_mod_profit_usd
    OWNER TO ictasadmin;
