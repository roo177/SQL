-- View: public.q_cb_mod_profit_eur

-- DROP VIEW public.q_cb_mod_profit_eur;

CREATE OR REPLACE VIEW public.q_cb_mod_profit_eur
 AS
...
ALTER TABLE public.q_cb_mod_profit_eur
    OWNER TO ictasadmin;
