-- FUNCTION: q_cb_mod_profit_mt()

DROP FUNCTION IF EXISTS q_cb_mod_profit_mt();

CREATE OR REPLACE FUNCTION q_cb_mod_profit_mt(
	)
    RETURNS boolean
    LANGUAGE 'plpgsql'
    COST 100
...
CREATE TEMPORARY TABLE t_cb_mod_profit_st
(
...
ALTER FUNCTION q_cb_mod_profit_mt()
    OWNER TO ictasadmin;
