-- FUNCTION: q_cb_mod_exp_try_mt()

DROP FUNCTION IF EXISTS q_cb_mod_exp_try_mt();

CREATE OR REPLACE FUNCTION q_cb_mod_exp_try_mt(
	)
    RETURNS boolean
    LANGUAGE 'plpgsql'
    COST 100
...
CREATE TEMPORARY TABLE t_cb_mod_exp_try_st
(
...
Delete from t_cb_mod_exp_try_st;
Raise notice 'Appending new data';

Insert into t_cb_mod_exp_try_st
select q_cb_mod_exp_try.rep_month, 
...
--ALTER FUNCTION q_cb_mod_exp_try_mt()
--    OWNER TO ictasadmin;
