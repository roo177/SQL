-- View: public.q_bb_inc_eur

-- DROP VIEW public.q_bb_inc_eur;

CREATE OR REPLACE VIEW public.q_bb_inc_eur
 AS
 SELECT t_bb_inc_st.rep_month,
    ...
    t_bb_inc_st.curr,
        CASE
            WHEN t_bb_inc_st.curr::text = 'EUR'::text THEN t_bb_inc_st.inc_total
            ELSE
            CASE
                WHEN t_bb_inc_st.curr::text = 'USD'::text THEN t_bb_inc_st.inc_total * t_bb_mon_curr_rates.r_usd_eur::double precision
                ELSE t_bb_inc_st.inc_total * t_bb_mon_curr_rates.r_try_eur::double precision
            END
        END AS eur_income,
...
ALTER TABLE public.q_bb_inc_eur
    OWNER TO ictasadmin;
