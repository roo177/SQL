-- Table: public.t_bb_inc_esc_rates_pcode

DROP TABLE IF EXISTS public.t_bb_inc_esc_rates_pcode;

CREATE TABLE IF NOT EXISTS public.t_bb_inc_esc_rates_pcode
(
    ...
    CONSTRAINT pkey_t_bb_inc_esc_rates PRIMARY KEY (rep_month, pc, month),
...
ALTER TABLE IF EXISTS public.t_bb_inc_esc_rates_pcode
    OWNER to ictasadmin;