...
CREATE OR REPLACE VIEW public.q_bb_monthly_curr_rates_inc
 ...
 SELECT q_bb_qty_activem_works_monthly.rep_month,
    ...
    q_bb_monthly_curr_rates_activem.r_eur_usd / q_bb_curr_base_val.r_eur_usd - 1::numeric AS rt_eur_usd,
   ...
   FROM q_bb_qty_activem_works_monthly
     LEFT JOIN q_bb_monthly_curr_rates_activem ON q_bb_qty_activem_works_monthly.exp_base_mon = q_bb_monthly_curr_rates_activem.exp_base_mon AND q_bb_qty_activem_works_monthly.rep_month::text = q_bb_monthly_curr_rates_activem.rep_month::text
