...
--ALTER TABLE IF EXISTS public.t_bb_exp_st
--OWNER to ictasadmin;

Raise notice 'Deleting existing data';
Delete from t_bb_exp_st;
Raise notice 'Appending new data';

Insert into t_bb_exp_st
select q_bb_exp.rep_month, 
q_bb_exp.pc as pc, 
l_1 || '.' || l_2 || '.' || l_3 || '.' || l_4 || '.' || l_5 || '.' || l_6 as j_code, 
c2_code.desc_tr_l2, 
c3_code.desc_tr_l3, 
q_bb_exp.month, 
sum(q_bb_exp.total_expense) as total_expense, 
q_bb_exp.curr, 
q_bb_exp.l_1, 
q_bb_exp.l_2, 
q_bb_exp.l_3, 
...
q_bb_exp.l_5, 
q_bb_exp.l_6, 
q_bb_exp.key_r_pc_l6
from q_bb_exp left join (c2_code right join c3_code on (c2_code.c_l1 = c3_code.c_l1) and (c2_code.c_l2 = c3_code.c_l2)) on (q_bb_exp.l_1 = c3_code.c_l1) and (q_bb_exp.l_2 = c3_code.c_l2) and (q_bb_exp.l_3 = c3_code.c_l3)
group by q_bb_exp.rep_month, q_bb_exp.pc, l_1 || '.' || l_2 || '.' || l_3 || '.' || l_4 || '.' || l_5 || '.' || l_6, c2_code.desc_tr_l2, c3_code.desc_tr_l3, q_bb_exp.month, q_bb_exp.curr, q_bb_exp.l_1, q_bb_exp.l_2, q_bb_exp.l_3, q_bb_exp.l_4, q_bb_exp.l_5, q_bb_exp.l_6, q_bb_exp.key_r_pc_l6;
...
ALTER FUNCTION public.q_bb_exp_mt()
    OWNER TO ictasadmin;
