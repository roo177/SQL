...
left join c2_code on (q_bb_profit_try.l_2 = c2_code.c_l2) and (q_bb_profit_try.l_1 = c2_code.c_l1)) left join c6_code on (q_bb_profit_try.l_6 = c6_code.c_l6) 
and (q_bb_profit_try.l_5 = c6_code.c_l5) and (q_bb_profit_try.l_4 = c6_code.c_l4) and (q_bb_profit_try.l_3 = c6_code.c_l3) and (q_bb_profit_try.l_2 = c6_code.c_l2) 
