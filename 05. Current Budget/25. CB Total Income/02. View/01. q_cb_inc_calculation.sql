...
CREATE OR REPLACE VIEW public.q_cb_inc_calculation
 ...
 SELECT t_cb_inc_qty.rep_month,
   ...
   FROM t_cb_inc_qty
     LEFT JOIN t_cb_inc_esc_rates_l6 ON t_cb_inc_qty.inc_base_mon = t_cb_inc_esc_rates_l6.month AND t_cb_inc_qty.l_6::text = t_cb_inc_esc_rates_l6.c_l6::text AND t_cb_inc_qty.l_5::text = t_cb_inc_esc_rates_l6.c_l5::text AND t_cb_inc_qty.l_4::text = t_cb_inc_esc_rates_l6.c_l4::text AND t_cb_inc_qty.l_3::text = t_cb_inc_esc_rates_l6.c_l3::text AND t_cb_inc_qty.l_2::text = t_cb_inc_esc_rates_l6.c_l2::text AND t_cb_inc_qty.l_1::text = t_cb_inc_esc_rates_l6.c_l1::text AND t_cb_inc_qty.pc::text = t_cb_inc_esc_rates_l6.p01_code::text AND t_cb_inc_qty.rep_month::text = t_cb_inc_esc_rates_l6.rep_month::text
     LEFT JOIN t_cb_inc_esc_rates_pcode ON t_cb_inc_qty.inc_base_mon = t_cb_inc_esc_rates_pcode.month AND t_cb_inc_qty.pc::text = t_cb_inc_esc_rates_pcode.p01_code::text AND t_cb_inc_qty.rep_month::text = t_cb_inc_esc_rates_pcode.rep_month::text
