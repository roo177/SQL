-- FUNCTION: public.q_cb_inc_try_mt()RFORM 

DROP FUNCTION IF EXISTS public.q_cb_inc_try_mt();

CREATE OR REPLACE FUNCTION public.q_cb_inc_try_mt(
	)
    RETURNS boolean
    LANGUAGE 'plpgsql'
    COST 100
...
--ALTER FUNCTION public.q_cb_inc_try_mt()
--    OWNER TO ictasadmin;
