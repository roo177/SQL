...
SELECT 
q_cb_inc.rep_month, 
q_cb_inc.pc, l_1 || '.' || l_2 || '.' || l_3 || '.' || l_4 || '.' || l_5 || '.' || l_6 AS j_code, 
c2_code.desc_tr_l2, 
c3_code.desc_tr_l3, 
...
q_cb_inc.l_6, 
c6_code.desc_tr_l6, 
q_cb_inc.key_r_pc_l6
FROM (q_cb_inc LEFT JOIN (c2_code RIGHT JOIN c3_code ON (c2_code.c_l1 = c3_code.c_l1) AND (c2_code.c_l2 = c3_code.c_l2)) ON (q_cb_inc.l_3 = c3_code.c_l3) 
AND (q_cb_inc.l_2 = c3_code.c_l2) AND (q_cb_inc.l_1 = c3_code.c_l1)) LEFT JOIN c6_code ON (q_cb_inc.l_6 = c6_code.c_l6) 
AND (q_cb_inc.l_5 = c6_code.c_l5) AND (q_cb_inc.l_4 = c6_code.c_l4) AND (q_cb_inc.l_3 = c6_code.c_l3) AND (q_cb_inc.l_2 = c6_code.c_l2) 
AND (q_cb_inc.l_1 = c6_code.c_l1)
GROUP BY 
q_cb_inc.rep_month, 
q_cb_inc.pc, 
