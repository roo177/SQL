-- Table: public.t_cb_exp_esc_rates_l6

-- DROP TABLE IF EXISTS public.t_cb_exp_esc_rates_l6;

CREATE TABLE IF NOT EXISTS public.t_cb_exp_esc_rates_l6
(
    ...
    CONSTRAINT t_cb_exp_esc_rates PRIMARY KEY (rep_month, pc, l_1, l_2, l_3, l_4, l_5, l_6, month),
...
ALTER TABLE IF EXISTS public.t_cb_exp_esc_rates_l6
    OWNER to ictasadmin;