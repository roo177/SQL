-- View: public.q_cb_up_coeff

-- DROP VIEW public.q_cb_up_coeff;

CREATE OR REPLACE VIEW public.q_cb_up_coeff
 AS
 SELECT q_cb_res_up_market_coeff.rep_month,
    q_cb_res_up_market_coeff.pc AS up_pr_code,
    ...
    q_cb_res_up_market_coeff.r_1_code AS up_rs_l1,
    q_cb_res_up_market_coeff.r_2_code AS up_rs_l2,
    q_cb_res_up_market_coeff.r_3_code AS up_rs_l3,
    q_cb_res_up_market_coeff.r_4_code AS up_rs_l4,
    ...
    q_cb_res_up_market_coeff.currency AS rs_currency,
