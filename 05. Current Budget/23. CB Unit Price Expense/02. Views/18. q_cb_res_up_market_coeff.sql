...
CREATE OR REPLACE VIEW public.q_cb_res_up_market_coeff
 ...
 SELECT q_cb_up_pre_coeff_activem_indexes.rep_month,
    ...
    q_cb_up_pre_coeff_activem_indexes.rs_l1 AS r_1_code,
    q_cb_up_pre_coeff_activem_indexes.rs_l2 AS r_2_code,
    q_cb_up_pre_coeff_activem_indexes.rs_l3 AS r_3_code,
    q_cb_up_pre_coeff_activem_indexes.rs_l4 AS r_4_code,
    ...
    q_cb_up_pre_coeff_activem_indexes.exp_cb_mon AS g_month,
    ...
    (((q_cb_up_pre_coeff_activem_indexes.key_full::text || '.'::text) || q_cb_up_pre_coeff_activem_indexes.rs_currency::text) || '.'::text) || q_cb_up_pre_coeff_activem_indexes.exp_cb_mon AS key_full_comb
