-- Table: public.t_pl_res_up

-- DROP TABLE IF EXISTS public.t_pl_res_up;

CREATE TABLE IF NOT EXISTS public.t_pl_res_up
(
    ...
    CONSTRAINT t_pl_res_up_pkey PRIMARY KEY (rep_month, up_pr_code, up_rs_l1, up_rs_l2, up_rs_l3, up_rs_l4),
    CONSTRAINT r__t_pl_re__r4_code FOREIGN KEY (up_rs_l4, up_rs_l2, up_rs_l1, up_rs_l3)
        REFERENCES public.r4_code (r_4_code, r_2_code, r_1_code, r_3_code) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE RESTRICT,
    CONSTRAINT r__t_pl_re__t_001_p FOREIGN KEY (up_pr_code)
...
ALTER TABLE IF EXISTS public.t_pl_res_up
    OWNER to ictasadmin;