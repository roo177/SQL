-- Table: public.t_cb_exp

-- DROP TABLE IF EXISTS public.t_cb_exp;

CREATE TABLE IF NOT EXISTS public.t_cb_exp
(
    ...
    CONSTRAINT t_ac_exp_pkey PRIMARY KEY (rep_month, pc, l_1, l_2, l_3, l_4, l_5, l_6, exp_ac_mon, curr),
...
ALTER TABLE IF EXISTS public.t_cb_exp
    OWNER to ictasadmin;