...
EXECUTE format('INSERT INTO t_cb_mod_inc_st ( rep_month, user_id, session_id,  pc, desc_tr_l2, desc_tr_l3, inc_base_mon, inc_total, curr, l_1, l_2, l_3, l_4, l_5, l_6, desc_tr_l6, key_r_pc_l6 )
SELECT 
rep_month, %L, %L, pc, desc_tr_l2, desc_tr_l3, inc_base_mon, inc_total, curr, l_1, l_2, l_3, l_4, l_5, l_6, desc_tr_l6, key_r_pc_l6
from t_cb_inc_st
