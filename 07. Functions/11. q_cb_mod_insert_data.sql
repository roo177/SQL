...
EXECUTE format('DELETE FROM t_cb_exp_mod where user_id = %L AND session_id = %L', _user_id, _session_id);

EXECUTE format('INSERT INTO t_cb_exp_mod (rep_month, user_id, session_id, pc, l_1, l_2, l_3, l_4, l_5, l_6, exp_ac_mon, exp_ac_exp,curr,ccode)
SELECT 
