...
DROP VIEW IF EXISTS q_cb_mod_up_pre_coeff_activem_indexes;
...
DROP VIEW IF EXISTS q_cb_mod_work_up_without_coeff;
CREATE TEMPORARY VIEW q_cb_mod_work_up_without_coeff
 AS
...
-- View: q_cb_mod_inc_try

-- DROP VIEW q_cb_mod_inc_try;
 ...
 SELECT t_cb_inc_st.rep_month,
    ...
    t_cb_inc_st.curr,
        CASE
            ...
            ELSE
            CASE
                WHEN t_cb_inc_st.curr::text = 'EUR'::text THEN t_cb_inc_st.inc_total * t_cb_mod_mon_curr_rates.r_eur_try::double precision
                ELSE t_cb_inc_st.inc_total * t_cb_mod_mon_curr_rates.r_usd_try::double precision
            END
        END AS try_income,
   ...
   FROM t_cb_inc_st
     LEFT JOIN t_cb_mod_mon_curr_rates ON t_cb_inc_st.rep_month::text = t_cb_mod_mon_curr_rates.rep_month::text AND t_cb_inc_st.inc_base_mon = t_cb_mod_mon_curr_rates.month;

ALTER TABLE q_cb_mod_inc_try
    OWNER TO ictasadmin;

-- View: q_cb_mod_inc_usd

-- DROP VIEW q_cb_mod_inc_usd;
