-- View: public.q_cb_qty_activem_works_monthly

-- DROP VIEW public.q_cb_qty_activem_works_monthly;

CREATE OR REPLACE VIEW public.q_cb_qty_activem_works_monthly
 AS
...
ALTER TABLE public.q_cb_qty_activem_works_monthly
    OWNER TO ictasadmin;
